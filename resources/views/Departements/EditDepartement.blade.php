            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center"> MODIFICATION D'UN DEPARTEMENT </h4>
                                <form action="{{Route('updatDepartement',['id'=>$Departement->id])}}" id="step-form-horizontal" class="step-form-horizontal" method="post">
                                    @csrf
                                    <div>
                                        <section>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="text" name="intitule" class="form-control" value="{{$Departement->intituleDepartement}}" placeholder="Sigle de l'Etablissement" required>
                                                    </div>
                                                </div>
