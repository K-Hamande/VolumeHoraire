            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center"> LISTE DES DEPARTEMENTS </h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse($ListeDepartement as $Values)

                                                <tr>
                                                   
                                                    <td>
                                                         <span>{{$Values->ufr->intitule}} </span> 
                                                    </td>
                                                    <td>
                                                        <span>{{$Values->ufr->sigle }} </span>
                                                    </td>

                                                    <td>
                                                        <span>{{ $Values->intituleDepartement}} </span> 
                                                    </td>
                                                
                                                        <td> 
                                                            {{-- <a href=" {{Route('ajoutUE')}} "> <button type="button" class="btn btn-info">Administrer une UE</button> </a> --}}
                                                            <a href="{{Route('editDepartement',['id'=>$Values->id])}}"> <button type="button" class="btn btn-warning">Modifier</button> </a>
                                                            ...
                                                            <div class="modal fade" id="exampleModalCenter">
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{Route('deletDepartement',['id'=>$Values->id])}}"> <button type="button" class="btn btn-danger">OUI</button></a>
                                                                    </div>
                                                                    </div>       
                                                            </div>
                                                            </div>
