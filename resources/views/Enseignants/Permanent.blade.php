                            ...
                            <div>
                                ...
                                <section>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="responsabilite" class="form-control" placeholder="responsabilite" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="number" name="Numero" class="form-control" placeholder="Numero de l Authorisation" required>
                                            </div>
                                        </div>
                                    </div>
                                </section>
