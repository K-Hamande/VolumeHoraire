            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{Route('listResponsabilite')}}">liste des Responsabilite</a></li>
                        <li class="breadcrumb-item active"><a href="{{Route('responsabilite')}}">Ajout de Responsabilite</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{Route('updatGrade',['id'=>$Responsabilite->id])}}" id="step-form-horizontal" class="step-form-horizontal" method="post">
                                    @csrf
                                    <div>
                                        <section>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="text" name="intitule" class="form-control" value="{{$Responsabilite->intituleResponsabilite}}" placeholder="Grade" required>
                                                    </div>
                                                </div>
