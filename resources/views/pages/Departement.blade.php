                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="intituleDepartement" class="form-control" placeholder="choisir UFR" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="intituleDepartement" class="form-control" placeholder="intitule Departement" >
                                            </div>
                                        </div>
                                        <div class="col-lg-6 ">
                                            <div class="">
