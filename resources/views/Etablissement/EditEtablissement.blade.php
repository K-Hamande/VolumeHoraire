            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center"> MODIFICATION D'ETABLISSEMENT </h4>
                                <form action="{{Route('updatEtablissement',['id'=>$Etablissement->id])}}" id="step-form-horizontal" class="step-form-horizontal" method="post">
                                    @csrf
                                    <div>
                                        <section>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="text" name="intitule" class="form-control"  value="{{$Etablissement->intitule}}" placeholder="Intitulé de l'Etablissement" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="text" name="sigle" class="form-control" value="{{$Etablissement->sigle}}" placeholder="Sigle de l'Etablissement" required>
                                                    </div>
                                                </div>
